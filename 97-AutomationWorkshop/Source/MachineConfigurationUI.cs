...
namespace YFAutomation
{
    ...
    public class XUiC_YFAutomationConfiguration : XUiController
    {
        ...
        {base.OnOpen();open=true;Active=this;
            ...
            kind="";draft=new MachineSettings();search.Text="";page=0;lastQuery="";Send(false);}
        ...
        void Render()
        {
            ...
            GetChildById("details").ViewComponent.IsVisible=!boxes;Label("details",Details());
