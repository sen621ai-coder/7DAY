...
param([string]$RuntimeDll='E:/soft/7DTD-Modding/Automation020-Staging/YF.Automation.dll')
...
foreach($relative in @('ModInfo.xml','Config/blocks.xml','Config/items.xml','Config/recipes.xml','Config/Localization.csv','Config/XUi_InGame/xui.xml')){
...
if(Test-Path -LiteralPath $installed){
 $backupDir='E:/soft/7DTD-Modding/AutomationBackups'
