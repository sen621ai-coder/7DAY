...
$replies=@{0='你好，很高兴见到你！';1='废土里很危险。选择任务后，我们一起坚持到最后吧。';2='好呀，我跟着你。';3='我在这里等你，记得回来。';4='能平安见到你，就是今天的好事。';5='我正在跟随另一位伙伴，请先让对方叫停。';6='我是原地守护角色，请选择守护任务。';16='任务已接取！可以在任务日志中查看进度，并在地图和指南针上查看目标。';20='任务进度已更新，请查看任务日志。';21='任务已放弃，本次没有奖励。';22='奖励已发放：公爵币和同阶奖励箱在你脚边，经验已到账。';23='现在由你带路。';30='任务系统暂时无法处理，请联系服主查看日志。';31='这位角色已经接取过任务，或你已有进行中的任务。';32='没有找到地图上的商店，暂时无法接取。';33='需要先完成 T16–T19 商人任务，获得对应救援委托。';34='只有任务成员可以操作；暂停和放弃需要当前带领者。';35='暂不可领奖：须完成任务并参与至少一半时间，且尚未领取。';36='缺少奖励箱物品配置。未消耗领奖资格，请联系服主。';37='服务器没有及时回应，请查看任务进度后重试。';38='这次任务已失败，护送已结束，本次没有奖励。';39='这不是分配给你的救援委托，或已开始救援。请查看任务日志。'}
...
$csv=Join-Path $root 'Localization.csv';$existing=Get-Content $csv|Where-Object {$_ -notmatch '^(sakuraNative_|mintNative_|sakuraEscortT\d+(Name|Desc),|mintGuardT\d+(Name|Desc),)'};@($existing)+@($lines)|Set-Content $csv -Encoding utf8
