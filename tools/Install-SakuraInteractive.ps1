...
foreach($file in @('Sakura.Preview.dll','ModInfo.xml','Config/entityclasses.xml','Config/dialogs.xml','Config/quests.xml','Config/npc.xml','Config/XUi_InGame/xui.xml','Config/XUi_InGame/windows.xml','Config/Localization.csv','Resources/sakura-preview.unity3d','Resources/mint-guardian.unity3d')){
