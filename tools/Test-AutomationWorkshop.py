...
c=Path(sys.argv[1]).resolve() if len(sys.argv)>1 else root/'97-AutomationWorkshop/Config'
game=(Path(sys.argv[2]).resolve() if len(sys.argv)>2 else root.parent)/'Data/Config'
