...
namespace AECT16RuntimeFix { public static class AutoForestryPresentation { public static void Build(UnityEngine.GameObject root,string assets,UnityEngine.Material[] materials,UnityEngine.Material metal,UnityEngine.Material dark){            var lamp=AutoForestryMachinery.Box(root.transform,"WorkLamp",new UnityEngine.Vector3(-2.7f,1.85f,-1.85f),new UnityEngine.Vector3(.40f,.09f,.18f),metal);
            AutoForestryMachinery.Box(root.transform,"LampSupport",new UnityEngine.Vector3(-2.7f,1.45f,-1.75f),new UnityEngine.Vector3(.04f,.8f,.04f),dark);
}}}
