...
public static class SiegeRegression
{
    ...
    public static string Rules()
    {
        ...
        return "PASS: siege GS 180000/280000/380000/480000, 600 replacement cases, raised caps, range/structure filters, assembly-qualified factories and native AI parameter parsing.";
    }
