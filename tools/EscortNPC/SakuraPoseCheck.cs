...
public static class SakuraPoseCheck {
 public static void Run(){
  ...
  foreach(var renderer in root.GetComponentsInChildren<SkinnedMeshRenderer>()){
   ...
   var m=new Material(Shader.Find("Unlit/Texture"));m.mainTexture=renderer.sharedMaterial.mainTexture;renderer.sharedMaterial=m;
  }
  ...
  var light=new GameObject("Key").AddComponent<Light>();light.type=LightType.Directional;light.intensity=1.2f;light.transform.rotation=Quaternion.Euler(35,-35,0);
